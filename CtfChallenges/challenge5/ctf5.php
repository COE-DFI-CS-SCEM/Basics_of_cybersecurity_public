...
<a href="../../dashboard.php"><button type="button" class="back_button" >Back to Dashboard</button></a>
    ...
    <h1 style="color: black; text-align: center; font-style: bold;">CTF Challenge 5</h1>
    ...
    <div class="signup-container">
        ...
        <p id="descr">
        A web-based Capture The Flag (CTF) competition is an online cybersecurity challenge where participants solve puzzles and exploit vulnerabilities in web applications to find hidden flags. <br>
        </p>
        <h3 align="left"><u><ul>Instructions :</ul></u></h3>
        <p id="descr">
            <ul id="descr">
                <li>Click <a href="project1.html">here </a>to open webpage.</li>
                <li>Find the flag present in it.</li>
    ...
    <form  id="form">
        <div class="input-group mb-3" id="drop" >
            ...
            <ul class="dropdown-menu  bg-transparent border-dark border-1.5" >
              <li><a class="dropdown-item "  > How do you inspect web code on browser?</a></li>
              <li><a class="dropdown-item "  > Add two flags</a></li>
