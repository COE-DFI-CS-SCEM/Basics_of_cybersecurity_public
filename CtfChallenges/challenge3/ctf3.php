...
<a href="../../dashboard.php"><button type="button" class="back_button" >Back to Dashboard</button></a>
    ...
    <h1 style="color: black; text-align: center; font-style: bold;">CTF Challenge 3</h1>
    ...
    <div class="signup-container">
        ...
        <p id="descr">
            A Linux command-based Capture the Flag (CTF) challenge is a type of cybersecurity competition where participants are tasked with solving problems using onlyLinux command-line tools.<br>
        </p>
        <h3 align="left"><u><ul>Instructions :</ul></u></h3>
        <p id="descr">
            <ul id="descr">
                <li>Use linux</li>
                <li>Click <a href="./hello.zip" download> here </a>to download</li>
                <li>Password for extracting:123ctf</li>
                <li>OR use online zip tools</li>
    ...
    <form  id="form">
        <div class="input-group mb-3" id="drop" >
            ...
            <ul class="dropdown-menu  bg-transparent border-dark border-1.5" >
              <li><a class="dropdown-item "  > Folder has a subfolder</a></li>
              <li><a class="dropdown-item "  > Hint image is present</a></li>
              <li><a class="dropdown-item "  > Flag file has the min. size</a></li>
