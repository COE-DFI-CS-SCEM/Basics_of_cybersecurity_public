...
<a href="../../dashboard.php"><button type="button" class="back_button" >Back to Dashboard</button></a>
    ...
    <h1 style="color: black; text-align: center; font-style: bold;">CTF Challenge 1</h1>
    <p><em>find the  </em><span>flag</span> </p>
    <div>

    <div class="signup-container">
        <img src="simley.jpg" alt="img1" id="img1">
        <img src="world.jpg" alt="img2" id="img2">
    ...
    <form  id="form">
        <div class="input-group mb-3" id="drop" >
            ...
            <ul class="dropdown-menu  bg-transparent border-dark border-1.5" >
              <li><a class="dropdown-item "  > Common Phrase in programming.</a></li>
